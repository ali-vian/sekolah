    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow-sm">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0">Edit Absensi Harian</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('absenharian.update', $absen->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <form id="delete-form-{{ $absen->id }}" action="{{ route('absenharian.destroy', $absen->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
