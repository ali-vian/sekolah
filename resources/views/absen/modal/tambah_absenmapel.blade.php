...
<div class="modal fade" id="tambahabsen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="/absenmapel/store" method="POST">
        @csrf
        ...
        <div class="modal-body">
          ...
          <div class="row mb-3">
            ...
            <div class="my-3 col-md-6">
                <label for="jadwal_id" class="form-label">Mata Pelajaran</label>
                <input class="form-control" type="text" value="{{ $jadwals->nama_mapel }}" readonly>
                <input type="hidden" name="jadwal_id" value="{{ $jadwals->id }}">
            </div>
            <div class="col-md-6" style="margin-top: 48px">
              <button type="button" class="btn btn-success" onclick="toggleHadir()" id="btnHadir">
                  Tandai Semua Hadir
              </button>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table id="datatable" class="table " data-toggle="data-tableMapel">
                <thead>
                    <tr>
                 <th>No</th>     
                <th>Nama Siswa</th>
