<div>
    ...
    <div>
        {{-- <form wire:submit="save" class="w-full max-w-sm flex mt-2">
            ...
            <div class="flex items-center justify-between mt-3 z-30 prose">
                <button type="submit"  
                style="background-color: #2563EB; margin-left: 10px;"
                wire:loading.attr="disabled"
                wire:target="save"
                class="text-white text-sm   py-2 px-4 rounded-md font-bold">
        ...
        <form wire:submit.prevent="save" class="w-full max-w-sm flex mt-2">
            ...
            <div class="flex items-center justify-between mt-3">
                <!-- Tombol hanya aktif setelah file selesai diunggah -->
                <button type="submit"  
                    class="text-white text-sm py-2 px-4 rounded-md font-bold"
                    style="background-color: #2563EB; margin-left: 10px;"
                    wire:loading.attr="disabled" 
                    ...
                    <span wire:loading.remove wire:target="file" class="inline-flex items-center gap-1">
                        <svg wire:loading wire:target="save" aria-hidden="true" class="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
